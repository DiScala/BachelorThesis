...
namespace SudokuSolverApp
{
    ...
    class MainScreen : Form
    {
        ...
        CheckBox[] strategyboxes = new CheckBox[13];
        CheckBox CBEbox = new CheckBox(), PMD1box = new CheckBox(), PMD2box = new CheckBox(), PMD3box = new CheckBox(),
                 ...
                 N3Ebox = new CheckBox(), P2Ebox = new CheckBox(), P3Ebox = new CheckBox(), H2Ebox = new CheckBox(), XWEbox = new CheckBox();
        ...
        Allowed CBEskip = new Allowed(false), PMDskip = new Allowed(false), HBEskip = new Allowed(false), LRCskip = new Allowed(false),
                ...
                H2Eskip = new Allowed(false), XWEskip = new Allowed(false), AIskip = new Allowed(true);
        ...
        public MainScreen()
        {
            ...
            skips = new Allowed[10] { CBEskip ,PMDskip,HBEskip, LRCskip ,
                PMIskip ,N2Eskip , N3Eskip ,PTEskip ,
                H2Eskip, XWEskip };
            ...
            strategylabel.Location = new Point(850, 120);
            Controls.Add(strategylabel);

            difficultylabel.Text = "--\nI\nm\np\nl\ni\nc\ni\nt\n\n\n\n\n\n--\nB\ne\ng\ni\nn\nn\ne\nr\n\n--\nI\nn\nt\ne\nr\nm\ne\nd\ni\na\nt\ne\n\n--\nA\nd\nv\na\nn\nc\ne\nd";
            difficultylabel.Font = difficultyfont;
            difficultylabel.Size = new Size(40, 800);
            difficultylabel.Location = new Point(1010, 140);
            Controls.Add(difficultylabel);

            signlabel.Text = "Made by Daan Di Scala (2020)";
            signlabel.Font = fieldlabelfont;
            signlabel.Size = new Size(300, 30);
            signlabel.Location = new Point(300, 75);
            ...
            strategyboxes[8] = N3Ebox; N3Ebox.Click += N3Eclick;
            strategyboxes[9] = P2Ebox; P2Ebox.Click += P2Eclick;
            strategyboxes[10] = P3Ebox; P3Ebox.Click += P3Eclick;
            strategyboxes[11] = H2Ebox; H2Ebox.Click += H2Eclick;
            strategyboxes[12] = XWEbox; XWEbox.Click += XWEclick;

            for (int i = 0; i < strategyboxes.Length; i++)
            {
                strategyboxes[i].Location = new Point(800, 150 + i * 52);
                strategyboxes[i].Appearance = Appearance.Button;
                strategyboxes[i].Font = smallbuttonfont;
                strategyboxes[i].Cursor = Cursors.Hand;
                strategyboxes[i].Size = new Size(200, 40);
